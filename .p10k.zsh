# Generated by Powerlevel10k configuration wizard on 2022-05-06 at 01:01 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%051F╭─'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%051F├|'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%051F╰─▶'
 ...
 #################################[ os_icon: os identifier ]##################################
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='ﱲ'
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=051
